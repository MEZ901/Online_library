...
if (
  typeof document.getElementById("cstmCover") !== "undefined" &&
  document.getElementById("cstmCover") !== null
) {
...
if (
  typeof document.forms["loginForm"] !== "undefined" &&
  document.forms["loginForm"] !== null
) {
...
if (
  typeof document.forms["signUpForm"] !== "undefined" &&
  document.forms["signUpForm"] !== null
) {
  ...
  function passwordChecker() {
    ...
    if (password.value != "") {
      ...
      if (
        ...
        (password.value.match(regExpWeak) ||
